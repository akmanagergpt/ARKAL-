...
| Branch | `main` |
| Generated at commit | `8102f60a2c0dff835ff95bd045daceffacbc13d3` — the `head:` claim in the §12 block. A derived control refuses any other commit in this section, so this row cannot rot the way it did before F-0047 |
