...
| 5 | Persistence + Project Registry + Minimal Backup/Restore | **UNLOCKED — IN PROGRESS, NOT ACCEPTED** (Packages 1–3 complete: C-03 persistence foundation, C-12 Project/Revision Registry, minimal backup/restore under `lifecycle.recovery`. Package 4 — API + frontend vertical slice — not started. No phase report, no traceability record, no gate run) |
...
- **No API, frontend or E2E surface** — Phase 5 Package 4. `ARK-REQ-0009`, `ARK-REQ-0178` and `ARK-REQ-0229` are untouched.
